...
def _Participant_Metrics(Filenames, Processing_filepairs):
    ...
    Participants_HS_TO["PN" + Filenames['participant_num']]["HeelStrike_SIMI_Normal"] = HeelStrike_SIMI['Normal']
    Participants_HS_TO["PN" + Filenames['participant_num']]["HeelStrike_SIMI_Fast"] = HeelStrike_SIMI['Fast']
    Participants_HS_TO["PN" + Filenames['participant_num']]["HeelStrike_SIMI_Slow"] = HeelStrike_SIMI['Slow']
    Participants_HS_TO["PN" + Filenames['participant_num']]["HeelStrike_SIMI_Carpet"] = HeelStrike_SIMI['Carpet']
    Participants_HS_TO["PN" + Filenames['participant_num']]["HeelStrike_SIMI_All"] = HeelStrike_SIMI['All']

    Participants_HS_TO["PN" + Filenames['participant_num']]["ToeOff_SIMI_Normal"] = ToeOff_SIMI['Normal']
    Participants_HS_TO["PN" + Filenames['participant_num']]["ToeOff_SIMI_Fast"] = ToeOff_SIMI['Fast']
    Participants_HS_TO["PN" + Filenames['participant_num']]["ToeOff_SIMI_Slow"] = ToeOff_SIMI['Slow']
    Participants_HS_TO["PN" + Filenames['participant_num']]["ToeOff_SIMI_Carpet"] = ToeOff_SIMI['Carpet']
    Participants_HS_TO["PN" + Filenames['participant_num']]["ToeOff_SIMI_All"] = ToeOff_SIMI['All']

    Participants_HS_TO["PN" + Filenames['participant_num']]["HeelStrike_GS_Normal"] = HeelStrike_GS['Normal']
    Participants_HS_TO["PN" + Filenames['participant_num']]["HeelStrike_GS_Fast"] = HeelStrike_GS['Fast']
    Participants_HS_TO["PN" + Filenames['participant_num']]["HeelStrike_GS_Slow"] = HeelStrike_GS['Slow']
    Participants_HS_TO["PN" + Filenames['participant_num']]["HeelStrike_GS_Carpet"] = HeelStrike_GS['Carpet']
    Participants_HS_TO["PN" + Filenames['participant_num']]["HeelStrike_GS_All"] = HeelStrike_GS['All']

    Participants_HS_TO["PN" + Filenames['participant_num']]["ToeOff_GS_Normal"] = ToeOff_GS['Normal']
    Participants_HS_TO["PN" + Filenames['participant_num']]["ToeOff_GS_Fast"] = ToeOff_GS['Fast']
    Participants_HS_TO["PN" + Filenames['participant_num']]["ToeOff_GS_Slow"] = ToeOff_GS['Slow']
    Participants_HS_TO["PN" + Filenames['participant_num']]["ToeOff_GS_Carpet"] = ToeOff_GS['Carpet']
...
for n in Participants:
    Current_Participant_Path = str(Path(parentpath, str(n)))
    Filenames = {}
    Filenames = _filenames(Filenames, Current_Participant_Path)
    print(Current_Participant_Path)
    Processing_filepairs = _filepair_chooser(Filenames)

    if 'Participants_HS_TO' not in locals():
