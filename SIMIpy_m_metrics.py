...
SIMIvars_Filtered = {
    # position vectors
    "Heel_Left": _butterworth_filter(SIMIvars['Heel_Left'], SIMIvars['time'], format='df', dim=3),
    "Heel_Right": _butterworth_filter(SIMIvars['Heel_Right'], SIMIvars['time'], format='df', dim=3),
    "Toe_Left": _butterworth_filter(SIMIvars['Toe_Left'], SIMIvars['time'], format='df', dim=3),
    "Toe_Right": _butterworth_filter(SIMIvars['Toe_Right'], SIMIvars['time'], format='df', dim=3),
    "Thigh_Left": _butterworth_filter(SIMIvars['Thigh_Left'], SIMIvars['time'], format='df', dim=3),
    "Thigh_Right": _butterworth_filter(SIMIvars['Thigh_Right'], SIMIvars['time'], format='df', dim=3),
    "Spine": _butterworth_filter(SIMIvars['Spine'], SIMIvars['time'], format='df', dim=3),
    # velocity vectors
    "Heel_Left_v": _butterworth_filter(SIMIvars['Heel_Left_v'], SIMIvars['time'], format='df', dim=3),
    "Heel_Right_v": _butterworth_filter(SIMIvars['Heel_Right_v'], SIMIvars['time'], format='df', dim=3),
    "Toe_Left_v": _butterworth_filter(SIMIvars['Toe_Left_v'], SIMIvars['time'], format='df', dim=3),
    "Toe_Right_v": _butterworth_filter(SIMIvars['Toe_Right_v'], SIMIvars['time'], format='df', dim=3),
    "Thigh_Left_v": _butterworth_filter(SIMIvars['Thigh_Left_v'], SIMIvars['time'], format='df', dim=3),
    "Thigh_Right_v": _butterworth_filter(SIMIvars['Thigh_Right_v'], SIMIvars['time'], format='df', dim=3),
    "Spine_v": _butterworth_filter(SIMIvars['Spine_v'], SIMIvars['time'], format='df', dim=3),
    # acceleration vectors
    "Heel_Left_a": _butterworth_filter(SIMIvars['Heel_Left_a'], SIMIvars['time'], format='df', dim=3),
    "Heel_Right_a": _butterworth_filter(SIMIvars['Heel_Right_a'], SIMIvars['time'], format='df', dim=3),
    "Toe_Left_a": _butterworth_filter(SIMIvars['Toe_Left_a'], SIMIvars['time'], format='df', dim=3),
    "Toe_Right_a": _butterworth_filter(SIMIvars['Toe_Right_a'], SIMIvars['time'], format='df', dim=3),
    "Thigh_Left_a": _butterworth_filter(SIMIvars['Thigh_Left_a'], SIMIvars['time'], format='df', dim=3),
    "Thigh_Right_a": _butterworth_filter(SIMIvars['Thigh_Right_a'], SIMIvars['time'], format='df', dim=3),
    "Spine_a": _butterworth_filter(SIMIvars['Spine_a'], SIMIvars['time'], format='df', dim=3)
}
